    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-gray-600">Demo — Disruptive Tech Brand</span>
        </div>
        <svg
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-gray-100 pt-4 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-medium text-gray-700 mb-1.5">Tone</p>
            ...
            <div>
              <p className="text-sm font-medium text-gray-700 mb-1.5">Avoid</p>
              <div className="flex flex-wrap gap-1.5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-800">Tech-savvy professionals, founders, and operators at growth-stage companies</p>
          </div>
          <p className="text-sm text-gray-600">Exemplar upload coming in v2 — using gold standard posts as quality benchmark.</p>
        </div>
      )}
    </div>
  )
